...
# handleSelectTier update
txt = txt.replace(
    "setActiveSelect(null);",
    "setActiveSelect(null);\n    if (run && stepIndex === 1) advanceTour();"
)

# wait, handleSelectTier has setActiveSelect(null)?
# Let's check handleSelectTier again, no, it has `setActiveSelect(null)` at the END of it?
# Let's verify `handleSelectTier` in my previous output:
#    }
#    setSlots(newSlots);
#    setActiveSelect(null);
#  };
